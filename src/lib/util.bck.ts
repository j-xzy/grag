...
// export function isInside(source: IGrag.IRect, target: IGrag.IRect) {
...
// export function calMaxBox(styles: IGrag.IRect[]) {
//   const box = {
...
// export function calBoundRect(style: IGrag.IRect, rotate: number) {
//   let minX = Infinity;
//   let minY = Infinity;
//   let maxX = -Infinity;
//   let maxY = -Infinity;
...
// export function calVertexByStyle(style: IGrag.IRect) {
//   return [
//     { x: style.x, y: style.y },
...
// export function calSelectedFtrs(mousePos: IGrag.IPos, mousedownCoord: IGrag.IPos, styles: Array<IGrag.IRect & { ftrId: string; }>) {
...
// export function calCenterByStyle(style: IGrag.IRect) {
//   return {
